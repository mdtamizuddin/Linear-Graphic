                ...
                <div className="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                    ...
                    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="mt-8">
                                <button className="loading w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
                                    Login
                                </button>
                            </div>
                        </form>
