                ...
                <div className="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
                    ...
                    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                        ...
                        <div className="flex items-center justify-between mt-4">
                            ...
                            <Link to='/signup' className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or Sign In</Link>
                            <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4" />
                        </div>
                    </div>
                </div>
