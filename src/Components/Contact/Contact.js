        ...
        <div>
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="lg:w-2/5 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:p-7 mt-8 md:mt-0">
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font text-4xl font-bold">Contact Us</h2>
