    ...
    return (
        <div className='priceing-card relative border-2 shadow-xl py-5 px-8 flex flex-col items-center rounded '>
            <div className='rounded  flex flex-col justify-left w-full'>
                <h1 className='text-3xl text-neutral text-left'>{price.type}</h1>
                <h1 className='text-4xl font-bold text-neutral text-left mt-2'>$ {price.price}/<span className='text-xl'>{type}</span></h1>
            </div>
            {/* heading End Here  */}
            <button className='btn  w-full btn-secondary btn-md rounded my-8'>Order Now</button>
